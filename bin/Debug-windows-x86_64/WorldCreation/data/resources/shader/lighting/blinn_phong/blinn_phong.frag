...
void main()
{
	...
	{
		fragmentColor = vec4(ambientColor, 1.0) * u_materialAmbientColor + vec4(diffuseColor, 1.0) * u_materialDiffuseColor + vec4(specularColor, 1.0) * u_materialSpecularColor;
	}
}